...
public class UserController extends AbstractController {
    ...
    private void handleUserRegistration(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException, UserCreationException, DataAccessException, UserNotFoundException, UserUpdateException {
    ...
    private void handleSetProfilePicture(int uid, HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException, BadParameterException, UserNotFoundException, UserUpdateException, DataAccessException {
        ...
        validateProfilePicture(imgPart, req, res);
    ...
    private void validateProfilePicture(Part imgPart, HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException, BadParameterException {
